...
public:
    ...
    void remoteKeyValNew(const uint32_t prodId, const uint32_t consId,
        ...
        (*channels)[prodId][consId]->asyncSend(std::move(std::unique_ptr<osuCrypto::ByteStream>(new osuCrypto::ByteStream((uint8_t*)serial_str.data(), serial_str.size()))));
    }
    ...
    void endRemoteKeyValNew(const uint32_t prodId, const uint32_t consId) {
        ...
        (*channels)[prodId][consId]->asyncSend(std::move(std::unique_ptr<osuCrypto::ByteStream>(new osuCrypto::ByteStream((uint8_t*)end_str.data(), end_str.size()))));
    }
    ...
    int getKeyValNew(const uint32_t prodId, const uint32_t consId) {
        ...
        (*channels)[consId][prodId]->recv(recv);
    ...
    void endGetKeyValNew(const uint32_t prodId, const uint32_t consId) {
        ...
        (*channels)[consId][prodId]->asyncSend(std::move(std::unique_ptr<osuCrypto::ByteStream>(new osuCrypto::ByteStream((uint8_t*)end_str.data(), end_str.size()))));
    }
    ...
    void EnsureEndGetKeyValNew(const uint32_t prodId, const uint32_t consId) {
        osuCrypto::ByteStream recv;
        (*channels)[prodId][consId]->recv(recv);
        std::string serial_str((char*)recv.data(), recv.size());
