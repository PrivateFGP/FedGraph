...
#include "graph.h"
#include "sshe_edge_centric_algo_kernel.h"
#include "task.h"
#include "TaskUtil.h"
...
class SSSPEdgeCentricAlgoKernel : public GraphGASLite::SSHEEdgeCentricAlgoKernel<GraphTileType> {
public:
...
protected:
    SSSPEdgeCentricAlgoKernel(const string& name, const GraphGASLite::VertexIdx& src)
        : GraphGASLite::SSHEEdgeCentricAlgoKernel<GraphTileType>(name),
          src_(src)
    {
        // Nothing else to do.
    }
